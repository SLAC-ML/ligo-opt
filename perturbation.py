...
def calc_perturbed_params(ETM_ROC, ITM_ROC, Cav_L):
    ...
    return (ETM_ROC_perturbed_pos, ETM_ROC, ETM_ROC_perturbed_neg), (ITM_ROC_perturbed_pos, ITM_ROC, ITM_ROC_perturbed_neg), (Cav_L_perturbed_pos, Cav_L, Cav_L_perturbed_neg)    